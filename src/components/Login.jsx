...
const Login = () => {
    ...
    const handleTwitterLogin = () => {
        // Redirect to the Django backend's Twitter login URL
        window.location.href = import.meta.env.VITE_DJANGO_TWITTER_LOGIN_REDIRECT_URL;
    };
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                <div>
                    ...
                    <button onClick={handleTwitterLogin} className="w-full flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
