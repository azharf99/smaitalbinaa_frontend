        ...
        <div className="relative md:flex min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-md transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:relative md:translate-x-0`}>
                ...
                <nav className="mt-4 px-2 overflow-y-auto h-screen" onClick={closeSidebar}>
                    ...
                    <NavLink to="/student-projects" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Student Projects</NavLink>
                    <NavLink to="/student-teams" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Student Teams</NavLink>
                    <NavLink to="/student-daily-plans" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Student Daily Plans</NavLink>
                    <NavLink to="/laporan-pertanggung-jawaban" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Laporan Pertanggung Jawaban</NavLink>
                    <NavLink to="/program-kerja" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Program Kerja</NavLink>
                    ...
                    <NavLink to="/olympiad-fields" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Olympiad Fields</NavLink>
                    <NavLink to="/olympiad-reports" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Olympiad Reports</NavLink>
                    <NavLink to="/periods" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Periods</NavLink>
                    <NavLink to="/schedules" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Schedules</NavLink>
                    <NavLink to="/reporter-schedules" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Reporter Schedules</NavLink>
                    <NavLink to="/class-reports" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Class Reports</NavLink>
                    <NavLink to="/class-reports-quick-create" className={({ isActive }) => `${navLinkClasses} ${isActive ? activeNavLinkClasses : ''}`}>Class Reports Quick Create</NavLink>
