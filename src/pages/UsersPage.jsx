    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label htmlFor="first_name" className="block text-sm font-medium dark:text-white text-gray-700">First Name</label>
                ...
                <div>
                    <label htmlFor="last_name" className="block text-sm font-medium dark:text-white text-gray-700">Last Name</label>
                ...
                <div>
                    <label htmlFor="password" className="block text-sm font-medium dark:text-white text-gray-700">{isEditing ? 'New Password' : 'Password'}</label>
                ...
                <div className="flex items-center pt-6">
                    ...
                    <label htmlFor="is_superuser" className="ml-2 block text-sm text-gray-900 dark:text-white">Superuser status</label>
                </div>
            </div>
            <div className="flex justify-end space-x-2 pt-4">
                <button type="button" onClick={onCancel} className="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium dark:text-white text-gray-700 bg-white hover:bg-gray-50 cursor-pointer" disabled={isSubmitting}>Cancel</button>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md overflow-x-auto dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    <tr>
                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium dark:text-white text-gray-500 uppercase tracking-wider">Username</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    {items.length > 0 ? items.map(item => (
                        <tr key={item.id}>
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium dark:text-white text-gray-900">{item.username}</td>
