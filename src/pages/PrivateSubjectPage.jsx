                            ...
                            {loading ? (
                                ...
                                <tr key={subject.id} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                        <button onClick={() => handleEdit(subject)} className="text-indigo-600 hover:text-indigo-900 dark:bg-gray-200 dark:p-1 dark:rounded-sm">Edit</button>
                                        <button onClick={() => handleDelete(subject.id)} className="text-red-600 hover:text-red-900 dark:bg-gray-200 dark:p-1 dark:rounded-sm">Delete</button>
                                    </td>
                                </tr>
                            )) : (
                                <tr>
