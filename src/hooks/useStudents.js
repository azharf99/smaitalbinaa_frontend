...
export const useStudents = (initialSearchQuery = '') => {
    ...
    const saveStudent = useCallback(async (formData, currentItem) => {
    ...
    return { items, count, nextPage, previousPage, isDataLoading, isSubmitting, error, searchQuery, setSearchQuery, saveStudent, deleteStudent, handlePageChange };
};