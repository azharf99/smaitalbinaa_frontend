...
export const useClasses = (initialSearchQuery = '') => {
    ...
    const saveClass = useCallback(async (formData, currentItem) => {
    ...
    return { items, count, nextPage, previousPage, isDataLoading, isSubmitting, error, searchQuery, setSearchQuery, saveClass, deleteClass, handlePageChange };
};