...
const API_URL = `${import.meta.env.VITE_API_BASE_URL}/api/v1/courses/`;
...
export const useCourses = (initialSearchQuery = '') => {
    ...
    const saveCourse = useCallback(async (formData, currentItem) => {
    ...
    return { items, count, nextPage, previousPage, isDataLoading, isSubmitting, error, searchQuery, setSearchQuery, saveCourse, deleteCourse, handlePageChange };
};